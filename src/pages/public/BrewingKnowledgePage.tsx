...
const DIAGNOSIS = [
  { symptom: '연하고 워터리하다', cause: '커피가 가진 것을 다 내어주기 전에 추출이 끝난 상태입니다.', fix: '물 온도를 살짝 올리거나 분쇄를 곱게, 추출 시간을 조금 더 늘려보세요.' },
  { symptom: '러프하다', cause: '필요한 것보다 더 많은 것을 뽑아낸 상태입니다.', fix: '물 온도를 낮추고 분쇄를 굵게, 추출 시간은 조금 짧게 가져가 보세요.' },
  { symptom: '물이 너무 천천히 빠진다', cause: '분쇄가 지나치게 곱거나 원두량이 많은 상태일 수 있습니다.', fix: '분쇄도를 한 단계만 굵게 조절해보세요.' },
  { symptom: '맛이 매번 다르다', cause: '한 잔 한 잔의 조건이 미세하게 흔들리고 있다는 신호입니다.', fix: '원두·분쇄도·물 온도·비율을 고정한 뒤, 한 번에 한 가지 변수만 바꿔가며 원인을 좁혀가세요.' },
]
