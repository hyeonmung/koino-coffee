    ...
    <div className="min-h-screen bg-warm-white">
      ...
      <main className="mx-auto max-w-[720px] px-6 py-10">
        ...
        <div className="mt-6 grid grid-cols-3 gap-3 sm:grid-cols-6">
          <SpecCell label="Coffee" value={guide.coffeeDose} />
          <SpecCell label="Water" value={guide.water} />
          <SpecCell label="Ratio" value={guide.ratio} />
          <SpecCell label="Temp" value={guide.temperature} />
          <SpecCell label="Grind" value={guide.grind} />
          <SpecCell label="Time" value={guide.totalTime} />
        </div>

        {guide.pourSteps.length > 0 && (
          <section className="mt-10">
            <h2 className="font-serif text-[16px] font-bold text-navy">Pour Timeline</h2>
        ...
        {guide.tips && (
          <section className="mt-8 border-t border-navy/15 pt-6">
            <p className="text-[10px] font-semibold tracking-[0.15em] text-navy/40">TIPS</p>
        ...
        {guide.commonProblems && (
          <section className="mt-6">
            <p className="text-[10px] font-semibold tracking-[0.15em] text-navy/40">COMMON PROBLEMS</p>
        ...
        {recommended.length > 0 && (
          <section className="mt-10 border-t border-navy/15 pt-8">
            <p className="text-[10px] font-semibold tracking-[0.15em] text-navy/40">RECOMMENDED COFFEES</p>
