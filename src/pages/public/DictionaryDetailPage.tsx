...
export default function DictionaryDetailPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-warm-white">
      ...
      <main className="w-full min-w-0 flex-1 mx-auto max-w-[640px] px-6 py-10">
        ...
        <section className="mt-8 border-t border-navy/10 pt-6">
          ...
          <p className="mt-2 text-[14px] leading-relaxed text-navy/75">{entry.short}</p>
        </section>

        {entry.easy && (
          <section className="mt-6">
            <h2 className="text-[11px] font-semibold tracking-[0.1em] text-accent">이런 느낌입니다</h2>
            <p className="mt-2 text-[14px] leading-relaxed text-navy/75">{entry.easy}</p>
          </section>
        )}
        ...
        {entry.example && (
          <section className="mt-6">
            ...
            <p className="mt-2 text-[14px] leading-relaxed text-navy/75">{entry.example}</p>
          </section>
        )}
