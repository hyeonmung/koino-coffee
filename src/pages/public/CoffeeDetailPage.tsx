        ...
        <div className="mx-auto max-w-[1280px] px-6 py-10">
            ...
            <div className="lg:col-span-5">
              ...
              <div className="mt-4 flex justify-center">
                <RadarChart
                  ...
                  accentSoft={characterAccentSoft}
                />
              </div>
          ...
          {(coffee.roasterComment || coffee.baristaComment) && (
            <section className="mt-10 border-t border-navy/15 pt-10">
              <div
                className={`grid grid-cols-1 gap-8 ${coffee.roasterComment && coffee.baristaComment ? 'sm:grid-cols-2' : ''}`}
              >
          ...
          {recipe && (
            <section className="mt-10 border-t border-navy/15 pt-10">
              ...
              <Link
                to={`/brew-guide/${recipe.slug}`}
                className="mt-5 inline-block text-[12px] font-semibold text-navy/60 hover:text-navy"
              >
                전체 브루 가이드 보기 →
              </Link>
            </section>
          ...
          <section className="mt-10 border-t border-navy/15 pt-10">
            ...
            {similar.length > 0 && (
              <>
                <h2 className="mt-4 font-serif text-[18px] font-bold text-navy">비슷한 커피</h2>
          ...
          {/* QR */}
          <section className="mt-10 border-t border-navy/15 pt-10 text-center">
